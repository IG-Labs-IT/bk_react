        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-12 md:gap-16">
          <div className="lg:w-1/2 space-y-6 animate-fade-in">
            ...
            <p className="text-lg md:text-xl text-foreground/80 max-w-xl">
              Comunicação preta em todos os sentidos.
Criada por pessoas pretas, para pessoas pretas. Nascemos com o propósito de construir um espaço de representatividade, potência e protagonismo preto nas mídias.
            </p>
